 ...
 * @see jspecview.util.Coordinate
 * @see jspecview.util.JDXDecompressor
 */

public class JDXCompressor {
   ...
   */
  public static String compressDIF(Coordinate[] xyCoords, int startDataPointIndex,
                                   int endDataPointIndex, double xFactor, double yFactor){
    String xStr = "", yStr = "", temp;
    Coordinate curXY;
   ...
   * @return A String representing the compressed data
   */
  public static String compressFIX(Coordinate[] xyCoords, int startDataPointIndex, int endDataPointIndex, double xFactor, double yFactor){
   ...
   * @return A String representing the compressed data
   */
  public static String compressSQZ(Coordinate[] xyCoords, int startDataPointIndex, int endDataPointIndex, double xFactor, double yFactor){
    String xStr = "", yStr = "", temp;
    Coordinate curXY;
   ...
   * @return A String representing the compressed data
   */
  public static String compressPAC(Coordinate[] xyCoords, int startDataPointIndex, int endDataPointIndex, double xFactor, double yFactor){
    DecimalFormat formatter = new DecimalFormat("#", new DecimalFormatSymbols(java.util.Locale.US ));
    int ij;
    String xStr = "", yStr = "", temp;
    Coordinate curXY;
