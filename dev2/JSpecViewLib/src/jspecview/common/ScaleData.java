 ...
 * {@link jspecview.common.View} may be generated by
 * {@link jspecview.common.View#generateScaleData(jspecview.common.Coordinate[][], int[], int[], int, int)}
...
public class ScaleData {
  ...
  int numOfPoints;
	 ...
	 * instead the more general {@link jspecview.common.View} is
	 * generated with the
	 * {@link jspecview.common.View#generateScaleData(jspecview.common.Coordinate[][], int[], int[], int, int)}
	 * method
	 * 
