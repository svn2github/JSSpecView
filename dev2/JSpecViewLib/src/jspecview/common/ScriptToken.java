...
public enum ScriptToken {
  ...
  SETPEAK("x (ppm), ?, or NONE", "sets a peak to a given value, one to be specified, or resets (1D NMR only)"),
  SETX("x (ppm), ?, or NONE", "sets a position in the spectrum to a given value, one to be specified, or resets (1D NMR only) (1D NMR only)"),
  SHIFTX("dx (ppm) or NONE", "shifts the x-axis of a 1D NMR spectrum by the given amount"),
