...
public class JSVPopupResourceBundle extends PopupResource {
  ...
  private static String[][] menuContents = {
      ...
      {   "OptionsMenu",
          "Toggle_Grid Toggle_X_Axis Toggle_Y_Axis Toggle_Coordinates Toggle_Trans/Abs Reverse_Plot Predicted_Solution_Colour Predicted_Solution_Colour_(interpolated)" }, //Window?
