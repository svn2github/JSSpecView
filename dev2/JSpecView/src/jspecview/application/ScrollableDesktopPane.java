...
//
//  private int style = STYLE_STACK;
//
//  public final static int STYLE_STACK = 0;
//  public final static int STYLE_CASCADE = 1;
//  public final static int STYLE_TILE = 2;
//
//  public int getStyle() {
//    return style;
//  }
...
//
//  public ScrollableDesktopPane(ScriptInterface si) {
//  	this.si = si;
...
////    JInternalFrame[] frames = getAllFrames();
//  //  for (int i = 0; i < frames.length; i++)
//    //  JSVFrame.getJSVPanelForFrame(si, (JSVFrame) frames[i]).setEnabled(isEnabled);
//  }
//
//  /*
